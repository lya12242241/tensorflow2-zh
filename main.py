...
def unet_train():
    ...
    width = 512
    X_train, y_train = [], []
    auth = oss2.Auth('<LTAI5t8Y63F2E6qqyLCUn5sm>', '<jEUqfKZTdWzQQO3eRofpNt8fyh6RhA>')
    ...
    print("开始训练u-net")
    model.fit(X_train, y_train, epochs=30, batch_size=15)#epochs和batch_size看个人情况调整，batch_size不要过大，否则内存容易溢出
